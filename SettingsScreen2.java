...
public class SettingsScreen2 implements Screen {
    ...
    public SettingsScreen2(final BirdFuryMain game) {
        ...
        backButton.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                int chapterNumber = game.getCurrentChapter();
                game.setScreen(new ChapterSelectScreen(game));  // Go back to the Chapter Select Screen
            }
        });
